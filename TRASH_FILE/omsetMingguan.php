...
$rows = $omset->getOmsetByWeek($whereClause);
            ...
            <?php include '../../component/notification.php'; ?>
              ...
              <div class="card mb-4">
                <div class="card-header">
                  <a href="omset.php" class="btn btn-primary bi-calendar-date"> Harian</a>
                  <a href="#" class="btn btn-primary bi-calendar-month"> Mingguan</a>
                  <a href="omsetBulanan.php" class="btn btn-primary bi-calendar3"> Bulanan</a>
                </div>
                <!-- CARD HEADER -->
                <div class="card-body">
                  <table class="table table-bordered">
                    ...
                    <?php if (count($paginated_data) > 0): ?>
                      ...
                      // Ambil tanggal acuan dari data (misalnya MIN(DATE))
                      $tanggalAsli = $row['start_date'];

                      // Geser ke hari Senin minggu itu
                      $senin = date('Y-m-d', strtotime($tanggalAsli . ' -' . (date('N', strtotime($tanggalAsli)) - 1) . ' days'));

                      // Hari Minggu = Senin + 6 hari
                      $minggu = date('Y-m-d', strtotime($senin . ' +6 days'));

                      // Format: 10 - 16 Juli 2023
                      $tanggalFormat = date("d", strtotime($senin)) . " - " . date("d", strtotime($minggu)) . " " .
                     $omset->bulanIndo(date("m", strtotime($minggu))) . " " .
                     date("Y", strtotime($minggu));                      ?>
                      ...
                      <?php endforeach; ?>
                    <?php else: ?>
                      <tr><td colspan='3' class='text-center py-2'>Tidak ada data</td></tr>
                    <?php endif; ?>
                  </tbody>
                </table>
              </div> <!-- /.card-body -->
