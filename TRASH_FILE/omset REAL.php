...
$rows = $omset->getOmsetByDay($whereClause);
            ...
            <?php include '../../component/notification.php'; ?>
              ...
              <div class="card mb-4">
                <div class="card-header">
                  ...
                  <a href="omsetMingguan.php" class="btn btn-primary bi-calendar-month"> Mingguan</a>
                ...
                <div class="card-body">
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="width: 5%">#</th>
                        <th style="width: 40%"><?= ($view == 'day') ? 'Tanggal' : "Minggu ke-" ?></th>
                        <th>Omset</th>
                      </tr>
                    </thead>
                    <!-- CARD BODY -->
                    ...
                    <?php if (count($paginated_data) > 0): ?>
                      <?php foreach ($paginated_data as $row):
                        ...
                        $tanggalFormat = date("d", strtotime($tanggal)) . " " . $omset->bulanIndo(date("m", strtotime($tanggal))) . " " . date("Y", strtotime($tanggal));
                         ?>
