            ...
            <div class="row g-0">
              ...
              <div class="px-5">
                ...
                <div class="card card-primary card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Tambah Supplier</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="../function/addSupplier.php" method="POST" class="">
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>
                                      ...
                                      <form action='../function/deleteSupplier.php' method='GET' style='display:inline-block; margin-right: 1px;'>
