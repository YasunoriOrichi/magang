...
include '../connect.php';
    ...
    if ($result->num_rows > 0) {
        ...
        $id = $row['ID'];  // ID supplier yang akan ditampilkan di form
        $nama = $row['NAME'];  // Nama supplier yang akan ditampilkan di form
        $ref_no = $row['REF_NO'];  // Nomor referensi supplier yang akan ditampilkan di form
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <!-- ITEM SUPPLIER -->
              <li class="nav-item">
                <a href="itemSupplier.php" class="nav-link">
            ...
            <div class="row g-0">
              ...
              <div class="px-5">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="../function/updateSupplier.php" method="POST">
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="mb-3">
