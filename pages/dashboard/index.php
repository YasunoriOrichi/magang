...
include $_SERVER['DOCUMENT_ROOT'] . '/function/repository.php';
...
// Hitung total item customer
$itemCustomerQuery = mysqli_query($conn, "SELECT COUNT(*) AS total FROM itemCustomer");
$itemCustomerData = mysqli_fetch_assoc($itemCustomerQuery);
$totalitemCustomer = $itemCustomerData['total'];
...
<html lang="en">
  ...
  <head>
    ...
    <title>Wevelope | Dashboard</title>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-danger">
                  ...
                  <a
                    href="../itemCustomer/itemCustomer.php"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    More info <i class="bi bi-link-45deg"></i>
                  </a>
