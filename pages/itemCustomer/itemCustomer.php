...
<html lang="en">
  <head>
    ...
    <title>Wevelope | Item Customer</title>
            ...
            <div class="card card-primary card-outline mb-4">
              <form method="GET">
                ...
                <div class="card mb-4">
                  ...
                  <a href="<?= $controller->formAddItemCustomer() ?>" class="btn btn-primary bi-plus-lg"> Tambah</a>
                </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                        ...
                        if (count($paginated_data) > 0): ?>
                          <?php foreach ($paginated_data as $row): ?>
                            <tr class='align-middle'>
                              ...
                              <td>
                                <a href="<?= $controller->formUpdateItemCustomer() . $row['ID']?>" class="btn btn-primary bi-pencil"></a>
                                <a href="<?= $controller->deleteItemCustomer() ?>&id=<?= $row['ID']?>" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?')" class="btn btn-danger bi-trash"></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php else: ?>
