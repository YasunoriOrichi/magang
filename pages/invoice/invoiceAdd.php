...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini sidebar-collapse bg-body-tertiary">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item menu-open">
                    <a href="../invoice/invoiceAdd.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Tambah Invoice</p>
                    </a>
                  </li>
                  ...
                  <form action="../../function/invoice/addInvoice.php" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="col-3">
                        ...
                        <input type="number" id="jumlah" name="jumlah[]" placeholder="Contoh: 10" class="form-control" required="">
                      </div>
                      <div class="col-3">
                      ...
                      <div class="col-3">
                        <a href="#" onclick="addItem()">+ Add new item</a>
                      </div>
                    </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
    ...
    <script>
  let itemCount = 0; // Untuk menghitung jumlah item yang ditambahkan

  function addItem() {
    itemCount++; // Increment itemCount setiap kali item ditambahkan
    ...
    item.innerHTML = `
      <div class="row">
        ...
        <div class="col-3">
          <input type="number" name="jumlah[]" placeholder="Contoh: 10" class="form-control" required="">
        </div>
        <div class="col-3">
          <input type="number" name="harga[]" placeholder="Kosongkan untuk harga default" class="form-control">
        </div>
        ${itemCount >= 1 ? `<div class="col-3">
  ...
  function removeItem(button) {
    button.closest('.item').remove(); // Menghapus seluruh baris
    itemCount--; // Decrement itemCount ketika item dihapus
  }
</script>
    <!--end::Script-->
  </body>
